# PAPER_LINEAGE.md — Version History for Paper 3

This file tracks the version history of Paper 3 (Ledgers: Admissible Dynamics, Entropy, and the Arrow of Time) and explains the relationship between the version in this release, the version on Zenodo, and any intermediate versions.
...
- **Concept DOI:** 10.5281/zenodo.18439363
...
- **v3.2** (current): see the main paper's changelog section for details.
...
**vv3.2 supersedes all earlier versions** for current reference. If citing for strict reproducibility of work published before this version, cite the version DOI from the specific Zenodo deposit the earlier work used.
...
*Generated by `create-repo`. The `- **v3.2** (current): see the main paper's changelog section for details.
