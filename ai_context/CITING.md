...
> Brooke, E. S. (2026). *Ledgers: Admissible Dynamics, Entropy, and the Arrow of Time*. Version v3.2. Zenodo. https://doi.org/10.5281/zenodo.18439363

**BibTeX:**

```bibtex
@misc{brooke_paper3_2026,
  ...
  url          = {https://doi.org/10.5281/zenodo.18439363}
}
```

The DOI `10.5281/zenodo.18439363` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
