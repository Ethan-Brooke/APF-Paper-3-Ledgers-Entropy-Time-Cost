...
> Brooke, E. S. (2026). *Ledgers: Admissible Dynamics, Entropy, and the Arrow of Time*. Version v3.2. Zenodo. https://doi.org/10.5281/zenodo.18604844
...
The DOI `10.5281/zenodo.18604844` is the concept DOI; it resolves to the latest version. Specific versions have their own version-DOIs (see the Zenodo record).
